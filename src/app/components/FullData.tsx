  ...
  return (
    ...
    <div className='w-400 h-100 lg:h-100 text-2xl xl:p-30 lg:p-20 p-10 flex lg:flex-row flex-col'>
        ...
        <div className='w-full lg:w-3/4'>
            ...
            <h2 className="text-3xl font-bold text-center mb-6 text-pink-700">Profil Karakter</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start">
                <FaStar className="text-pink-600 text-2xl mr-2" />
                <p><strong>Nama:</strong> Michiru Suhayla Aika</p>
                </div>
                <div className="flex items-start">
                <FaRibbon className="text-pink-500 text-2xl mr-2" />
                <p><strong>Panggilan:</strong> Aika</p>
                </div>
                <div className="flex items-start">
                <GiGalaxy className="text-pink-500 text-2xl mr-2" />
                <p><strong>Spesies:</strong> Ras Langit (kadang disalahpahami sebagai Succubus)</p>
                </div>
                <div className="flex items-start">
                <FaDove className="text-blue-500 text-2xl mr-2" />
                <p><strong>Status:</strong> Pensiunan Mercenary (PMC) | Intelijen Freelance</p>
                </div>
                <div className="flex items-start">
                <FaBullseye className="text-red-500 text-2xl mr-2" />
                <p><strong>Keahlian:</strong> Taktik, bela diri, crafting, intelijen</p>
                </div>
                <div className="flex items-start">
                <FaGamepad className="text-green-500 text-2xl mr-2" />
                <p><strong>Aktivitas Saat Ini:</strong> Berkreasi di dunia maya — berbagi cerita, bermain game, menginspirasi</p>
                </div>
                <div className="flex items-start">
                <FaComments className="text-yellow-500 text-2xl mr-2" />
            ...
            <div className="mt-8">
                ...
                <BsStars className="text-pink-500 text-2xl mr-2" />
                <p className="font-bold">Ciri Khas:</p>
                </div>
                <ul className="list-disc list-inside ml-8 text-gray-700 space-y-2">
