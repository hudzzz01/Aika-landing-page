      ...
      <div className="mt-250 sm:lg-200 lg:mt-150 max-w-4xl mx-auto p-8 bg-gradient-to-b from-white via-pink-50 to-pink-200 rounded-3xl shadow-2xl border border-pink-200">
        ...
        <div className="text-gray-800 text-lg leading-relaxed space-y-6">
          <p>
            ...
            serta ekor berbentuk hati yang berayun lembut sebagai simbol kasih.
          </p>
  
          <p>
            Dahulu, hidupnya jauh dari damai. Dunia mengajarinya untuk bertahan, bertempur,
            dan membuat keputusan sulit sebagai seorang <em>mercenary</em> dalam perusahaan militer swasta.
            Namun di balik keahlian bertarungnya, selalu tersimpan kerinduan akan dunia yang tenang.
          </p>
  
          <p>
            Kini, setelah pensiun, Aika memilih jalan baru: berbagi keceriaan di dunia maya,
            berinteraksi dengan teman-teman dari seluruh penjuru dunia,
            dan membuktikan bahwa kedamaian bukan sekadar mimpi, melainkan pilihan.
          </p>
  
          <p className="italic text-center text-pink-600 font-semibold">
